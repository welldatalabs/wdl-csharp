...
namespace wdl.sdk.core.services.v01
{
    ...
    /// </summary>
    public class SleevesService
    {
        private const string _endpoint = "sleeves";
        ...
        /// <summary>
        /// Initialize SleeveService with api authorization token.
        /// </summary>
        ...
        public SleevesService(string apiKey, string baseUri = null)
        {
            _apiKey = apiKey;
        ...
        /// <summary>
        /// Get sleeve data for a specific job id.  
        /// </summary>
        ...
        /// <returns>Collection of Sleeve objects.</returns>
        public IEnumerable<Sleeve> Get(string id, decimal? fromStageNumber = null, decimal? toStageNumber = null)
        {
            try
            {
        ...
        /// <param name="toStageNumber">Optional To Stage Number filter</param>/// 
        /// <returns>Collection of Sleeve objects.</returns>
        public async Task<IEnumerable<Sleeve>> GetAsync(string id, decimal? fromStageNumber = null, decimal? toStageNumber = null)
        {
            ...
            var sleeveJson = await HttpHelper.GetAsync(requestUri, _apiKey, _version);
            return sleeveJson.DeserializeJson<IEnumerable<Sleeve>>();
        }
